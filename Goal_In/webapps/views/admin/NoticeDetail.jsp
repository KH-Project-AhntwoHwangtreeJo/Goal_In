					...
					<div class="panel-body">
						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									<th>내용</th>
									<td><%=n.getNcontent().charAt(0)%><%=n.getNcontent().substring(1)%></td>
								</tr>
								<tr>
									<td colspan="2">
										<button
											onclick="location.href='/Goal_In/nUpView.no?nno=<%=n.getNno()%>'">수정하기</button>
										<button onclick="location.href='/Goal_In/NselectList.no'">메뉴로
											돌아가기</button>
									</td>
								</tr>
								</form>
