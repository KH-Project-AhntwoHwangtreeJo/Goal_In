	...
	pageEncoding="UTF-8" import="java.util.*, com.semi.report.model.vo.* ,com.semi.auth.model.vo.*"%>
<%
				...
				<div class="panel-body">
					<table cellpadding="0" cellspacing="0" border="0"
						...
						<tbody>
							<% for (Auth a : alist) { %>
                         	<% for (Report r : rlist) { %>
                         	<% if( a.getSignnum() == r.getSignnum()) { %>
							<tr>
								<td><%=r.getSignnum()%></td>
								<td><%=r.getUserid()%></td>
								<td><%=a.getGno()%></td>
								<td class="gallery"><img class="img-fluid small" src="/Goal_In/resources/authUploadFiles/<%=a.getSigncf()%>" alt="">
													<img class="img-fluid zoom" src="/Goal_In/resources/authUploadFiles/<%=a.getSigncf()%>" alt=""></td>
								<td><%=a.getSigndate()%></td>
								<td><label class="switch"> <input type="checkbox"
										onclick="toggleStatus(this)"
										<%=a.getSigntf().equals("Y") ? "checked" : ""%> /> <span
