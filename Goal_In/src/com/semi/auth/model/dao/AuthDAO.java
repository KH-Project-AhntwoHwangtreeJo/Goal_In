...
public class AuthDAO {
	...
	public AuthDAO() {
		...
		String filePath = AuthDAO.class.getResource("/config/auth.properties").getPath();
		try {
	...
	public int selectFirstAuth(Connection con, Auth a) {
		int result = 0;
		PreparedStatement pstmt = null;
		ResultSet rset = null;

		String sql = prop.getProperty("authupdate");
